...
\noindent Scenario 3. Treatment effect is added to $500$ genes randomly chosen from the genes with relatively low expression levels (35 ~ 70 percentile). The effect size $w_j$ is drawn from the set $\{\log_2(2), \log_2(3), \log_2(4), \log_2(5)\}$ with probability $\{0.3, 0.4, 0.2, 0.1\}$, and further added an $N(0, 0.1^2)$ noise on top of that.
